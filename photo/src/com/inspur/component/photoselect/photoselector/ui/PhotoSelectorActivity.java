...
import com.inspur.component.photoselect.photoselector.util.AnimationUtil;
...
public class PhotoSelectorActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null) {
            ...
            isShowCamera = getIntent().getBooleanExtra(CommonExtras.IS_SHOWCAMERA, false);
        }
...
//					getApplicationContext(), data.getData()));
            PhotoModel photoModel = new PhotoModel(onCaptureImageResult(data));
            // selected.clear();
            // //--keep all
            // selected photos
            // tvNumber.setText("(0)");
    ...
    private void ok() {
        if (selected.isEmpty()) {
            ...
            if (selected.size() >MAX_IMAGE) {
                ...
                bundle.putSerializable(CommonExtras.photos, selected);

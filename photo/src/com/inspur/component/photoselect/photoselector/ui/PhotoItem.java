...
public class PhotoItem extends LinearLayout implements OnCheckedChangeListener,
	...
	public void initSetting(boolean isShowCamera){
		if (isShowCamera){
			cbPhoto.setVisibility(GONE);

		}else {
			cbPhoto.setVisibility(VISIBLE);
	...
	public void setCameraPhoto(int drawable){
		ivPhoto.setImageResource(drawable);
				cbPhoto.setVisibility(GONE);
	}
	/** 设置路径下的图片对应的缩略图 */

package com.inspur.component.numberpicker.view;

import java.lang.annotation.Retention;
import java.lang.annotation.RetentionPolicy;

import com.inspur.component.numberpicker.BuildConfig;
import com.inspur.component.numberpicker.Coloring;
import com.inspur.component.numberpicker.R;
import com.inspur.component.numberpicker.listener.OnValueChangeListener;
...
public class ActualNumberPicker extends View {
    ...
    private SparseArray<Drawable> mControlIcons = new SparseArray<Drawable>(4);
    private SparseArray<Drawable> mControlsBacks = new SparseArray<Drawable>(4);
     ...
     * @param t The current time (or position) of the tween. This can be seconds or frames, steps, ms, whatever 鈥� as long as the unit is the
